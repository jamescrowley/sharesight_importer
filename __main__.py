...
def main():
    ...
    csv_importer.import_file(args.file_name, args.portfolio_name, args.country_code, args.use_seperate_income_account, args.use_usd_eur_account, args.delete_existing, args.min_date, args.min_line) 
main()
